# Protection Documents Index

This project maintains the following protection documents:

| Document | Purpose |
|----------|---------|
| `TERMS_OF_USE.md` | Terms governing interface use |
...
| `ASSET_REGISTER.md` | On-chain holdings record |
| `SECURITY.md` | Personal key management rules |
| `LICENSE-DISCLAIMER.md` | MIT licence boundary |

---

**Timestamp:** 2026-09-10 21:33:11 BST
