...
# ============================================================
#  PHB ULTIMATE EVERYTHING
#  All platforms: Xbox, PlayStation, PC, Switch, Mobile
#  All streaming: Twitch, YouTube, Netflix, Disney+, Golight
#  All networks: Cloudflare, Google, Smarty, Three
#  Full 5G lock + DMZ + all ports + DoH
# ============================================================

RED='\033[0;31m'; GREEN='\033[0;32m'; YELLOW='\033[1;33m'; BLUE='\033[0;34m'; PURPLE='\033[0;35m'; NC='\033[0m'

echo "======================================"
echo "  PHB ULTIMATE EVERYTHING"
echo "  All Platforms + All Streaming"
echo "======================================"
...
# ---- 7. Open ALL Ports (1-65535) ----
echo -e "\n${BLUE}[7] Opening ALL Ports (1-65535)...${NC}"
...
# ---- 8. Xbox Live Ports ----
echo -e "\n${BLUE}[8] Xbox Live Ports...${NC}"
for port in 88 3074 53 80 443 500 3544 4500 1863 5223; do
    post_xml '<?xml version="1.0"?><request><port>'$port'</port><protocol>both</protocol><enable>1</enable></request>' "portforward"
done
echo -e "   ${GREEN}✅ Xbox ports open${NC}"

# ---- 9. PlayStation Network Ports ----
echo -e "\n${BLUE}[9] PlayStation Ports...${NC}"
for port in 3478 3479 3480 5223 1935 1937; do
    post_xml '<?xml version="1.0"?><request><port>'$port'</port><protocol>both</protocol><enable>1</enable></request>' "portforward"
done
echo -e "   ${GREEN}✅ PlayStation ports open${NC}"

# ---- 10. PC Gaming Ports (Steam, Epic, Battle.net) ----
echo -e "\n${BLUE}[10] PC Gaming Ports...${NC}"
for port in 27015 27016 27017 27018 27019 27020 27021 27022 27023 27024 27025 3724 1119 1120 6112 6113 6114 6115 6116 6117 6118 6119 6120; do
    post_xml '<?xml version="1.0"?><request><port>'$port'</port><protocol>both</protocol><enable>1</enable></request>' "portforward"
done
echo -e "   ${GREEN}✅ PC ports open${NC}"

# ---- 11. Streaming Ports (Twitch, YouTube, Netflix, etc.) ----
echo -e "\n${BLUE}[11] Streaming Ports...${NC}"
for port in 1935 1937 3478 3479 3480 5223 554 8554 8080 8443 1755 1756; do
    post_xml '<?xml version="1.0"?><request><port>'$port'</port><protocol>both</protocol><enable>1</enable></request>' "portforward"
done
echo -e "   ${GREEN}✅ Streaming ports open${NC}"

# ---- 12. UDP Tunnels (VoIP, Gaming, Streaming) ----
echo -e "\n${BLUE}[12] UDP Tunnels...${NC}"
...
# ---- 14. LED Sync ----
echo -e "\n${BLUE}[14] LED Sync: Orange → Purple → Blue...${NC}"
...
# ---- 15. Install keep‑alive daemon ----
echo -e "\n${BLUE}[15] Installing keep‑alive daemon (0.1s)...${NC}"
...
echo -e "   Gaming ports: ${GREEN}OPEN${NC}"
echo -e "   Streaming ports: ${GREEN}OPEN${NC}"

# ---- 17. Summary ----
echo -e "\n${BLUE}========================================${NC}"
echo -e "${GREEN}✅ ULTIMATE EVERYTHING COMPLETE${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
echo "📊 Applied:"
...
echo ""
echo "📌 Supported platforms and services:"
echo "   🎮 Xbox Live, PlayStation Network, Steam, Epic, Battle.net"
echo "   📺 Twitch, YouTube, Netflix, Disney+, Golight Stream, Hulu, Amazon Prime"
echo "   🌐 Cloudflare, Google, Smarty, Three, all gaming servers"
echo "   📱 All mobile gaming (Call of Duty Mobile, PUBG, etc.)"
echo ""
echo "📌 Final status:"
echo "   • Network: $final_net (Signal: $final_sig)"
echo "   • LED: ${BLUE}BLUE${NC}"
echo "   • NAT: ${GREEN}OPEN${NC}"
echo ""
echo "📌 For best performance:"
echo "   1. Set your gaming device to static IP: 192.168.1.50"
echo "   2. Connect via Ethernet cable."
echo "   3. All ports are open for all platforms."
echo ""
